...
export const MOCK_HISTORY: HistoryEvent[] = [
  ...
  },
  {
    ...
    time: '09:45',
    type: 'deploy',
    title: '⚡ Развёртывание кластера NATS JetStream 3-Node',
    author: 'Инфра-агент',
    agents: ['Инфра-агент', 'DevOps'],
    details: 'Настроен кворум Raft для стримов orders.v1.* и Key-Value хранилища схем портала.',
    canRollback: true,
    status: 'resolved',
    relatedNodeId: 'infra-nats',
    servicesAffected: ['NATS JetStream', 'Event Mesh'],
  },
  {
    id: 'hist-nats-2',
    time: '09:30',
    type: 'decision',
    title: '📄 ADR-043: Принятие NATS JetStream как ядра Event Mesh',
    author: 'Иван Петров',
    agents: ['Архитектор'],
    details: 'Утверждён отказ от Apache Kafka в пользу NATS JetStream из-за сверхнизкой задержки (P99 1.6мс).',
    canRollback: false,
    status: 'approved',
    relatedNodeId: 'infra-nats',
    docsAffected: ['ADR-043'],
  },
  {
    id: 'hist-refund-1',
    time: '10:15',
    type: 'commit',
    title: '🔌 Спецификация POST /api/v1/orders/{id}/refund',
    author: 'API-агент',
    agents: ['API-агент', 'Billing'],
    prNumber: '#4820',
    details: 'Добавлена валидация схем, проверка лимитов эквайринга и генерация DTO ответов.',
    canRollback: true,
    status: 'merged',
    relatedNodeId: 'refund-endpoint',
    servicesAffected: ['API Gateway', 'Billing'],
    docsAffected: ['OpenAPI /refund'],
  },
  {
    id: 'hist-ui-1',
    time: '11:00',
    type: 'commit',
    title: '🖼️ UI: Карточка статуса возвратов и меню',
    author: 'UI/UX-агент',
    agents: ['UI/UX-агент'],
    prNumber: '#4821',
    details: 'Разработан компонент SideMenu и статус-бейдж для шагов компенсации саги.',
    canRollback: true,
    status: 'merged',
    relatedNodeId: 'ui-billing-menu',
    servicesAffected: ['Portal Frontend'],
  },
  {
    id: 'hist-sec-1',
    time: '09:20',
    type: 'commit',
    title: '🔐 PII Маскирование: фильтр номеров карт PCI DSS',
    author: 'SecOps-агент',
    agents: ['SecOps-агент'],
    prNumber: '#4819',
    details: 'Внедрён фильтр логирования: маскирование PAN номеров до формата 4276***1102.',
    canRollback: true,
    status: 'merged',
    relatedNodeId: 'sec-pii',
    servicesAffected: ['Audit Logger', 'Security Gateway'],
  },
  {
    id: 'hist-orders-1',
    time: '08:45',
    type: 'commit',
    title: '🏢 Реестр заказов: добавлены фильтры по статусу возврата',
    author: 'UI/UX-агент',
    agents: ['UI/UX-агент', 'Frontend'],
    prNumber: '#4818',
    details: 'Реализованы фильтры REFUND_REQUESTED и REFUNDED в таблице заказов.',
    canRollback: true,
    status: 'merged',
    relatedNodeId: 'ui-orders',
    servicesAffected: ['Portal Orders View'],
  },
  {
    id: 'hist-6',
    time: '09:00',
